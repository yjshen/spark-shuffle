...
public class ExternalShuffleBlockResolverWithCacheSuite {
  ...
  public void testBadRequests() throws IOException {
    ExternalShuffleBlockResolverWithCache resolver = new ExternalShuffleBlockResolverWithCache(conf, null, new MetricRegistry());
  ...
  private void assertPathsMatch(String p1, String p2, String p3, String expectedPathname) {
    String normPathname =
        ExternalShuffleBlockResolverWithCache.createNormalizedInternedPathname(p1, p2, p3);
